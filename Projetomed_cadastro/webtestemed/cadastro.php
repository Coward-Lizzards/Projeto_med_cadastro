...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($errors)) {
            ...
            if ($medico->cadastrar()) {
                echo "<div class='alert alert-success' role='alert'>Médico Cadastrado com Sucesso!</div>";
            } else {
                echo "<div class='alert alert-danger' role='alert'>Erro ao Cadastrar Médico.</div>";
            }
        } else {
